...
class QAEntity {
  ...
  QAEntity({this.data, this.errorCode, this.errorMsg});

  QAEntity.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new QAData.fromJson(json['data']) : null;
...
class QAData {
  ...
  QAData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datas'] != null) {
      datas = new List<QADatas>();
      json['datas'].forEach((v) {
        datas.add(new QADatas.fromJson(v));
      });
    }
    offset = json['offset'];
    over = json['over'];
...
class QADatas {
  ...
  QADatas.fromJson(Map<String, dynamic> json) {
    ...
    if (json['tags'] != null) {
      tags = new List<QATags>();
      json['tags'].forEach((v) {
        tags.add(new QATags.fromJson(v));
      });
    }
    title = json['title'];
    type = json['type'];
...
class QATags {
  ...
  QATags({this.name, this.url});

  QATags.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    url = json['url'];
  }
