...
class ProjectListData {
  int curPage;
  List<ProjectListDataDatas> datas;
  int offset;
  bool over;
  int pageCount;
  int size;
  ...
  ProjectListData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datas'] != null) {
      datas = new List<ProjectListDataDatas>();
      json['datas'].forEach((v) {
        datas.add(new ProjectListDataDatas.fromJson(v));
      });
    }
    offset = json['offset'];
    over = json['over'];
...
class ProjectListDataDatas {
  ...
  ProjectListDataDatas.fromJson(Map<String, dynamic> json) {
