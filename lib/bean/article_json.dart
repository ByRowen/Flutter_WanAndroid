...
class ArticleData {
  ...
  ArticleData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datas'] != null) {
      datas = new List<ArticleDetailDatas>();
      json['datas'].forEach((v) {
        datas.add(new ArticleDetailDatas.fromJson(v));
      });
    }
    offset = json['offset'];
    over = json['over'];
...
class ArticleDetailDatas {
  ...
  ArticleDetailDatas.fromJson(Map<String, dynamic> json) {
